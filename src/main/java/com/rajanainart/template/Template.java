...
public class Template {
    ...
    public static final String CONDITION   = "CONDITION_TEXT";
    ...
    public static final Map<String, BaseEntity> METHOD_HELPERS   = AppContext.getBeansOfType(BaseEntity.class, ExtensionMethod.class);
    ...
    public <T extends BaseEntity> boolean validate(List<T> contextInstances) {
        ...
        ExpressionEvaluator<T> evaluator  = new ExpressionEvaluator<>(expression, contextInstances, false);
        return evaluator.parseAsBoolean();
    }

    public <T extends BaseEntity> String parse(T contextInstance) {
        List<T> contextInstances = new ArrayList<>();
        contextInstances.add(contextInstance);
        return parse(contextInstances);
    }
